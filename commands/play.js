    ...
    try {
        ...
        if (loadType === 'playlist') {
            ...
            const errorEmbed = new EmbedBuilder()
                .setColor('#ff0000')
                .setTitle('Blad!')
                .setDescription('Nie znaleziono muzyki.');
...
const embeds = [
    ...
    new EmbedBuilder()
        ...
        .setDescription('➡️ **Dodano piosenke do kolejki.**\n➡️** Uzyj przyciskow ponizej aby kontrolowac kolejke muzyki.**'),

 
    new EmbedBuilder()
    .setColor('#ffea00')
    .setAuthor({
        name: 'Dodano piosenke!',
...
await interaction.followUp({ embeds: [embeds[randomIndex]] });
        ...
        console.error('Blad wywolania komendy /play:', error);
        const errorEmbed = new EmbedBuilder()
            .setColor('#ff0000')
            .setTitle('Error')
            .setDescription('Wystapil problem z wywolaniem komendy /play.');
...
module.exports = {
    ...
    options: [{
        name: 'name',
        description: 'Napisz nazwe piosenki, link do piosenki albo playliste.',
